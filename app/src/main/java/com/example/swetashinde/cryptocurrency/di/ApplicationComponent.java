 ...
 */
@Singleton
@Component(modules = {ApplicationModule.class, AndroidSupportInjectionModule.class,MainActivityModule.class,CryptoListFragmentModule.class, NetModule.class, RepositoryModule.class, UseCasesModule.class})
